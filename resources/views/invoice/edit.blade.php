...
<form action="{{ route('invoice.update', ['id' => $invoice->id]) }}"
method="post">
@csrf
...
<td></td>
<td>
<input type="hidden" name="_method" value="PUT" class="form-
control">
...
<td>
<input type="number" min="1" value="1" name="qty" class="form-
control" required>
</td>
<td colspan="3">
...
<tr>
<td>Pajak</td>
<td>:</td><td>2% (Rp {{ number_format($invoice->tax) }})</td>
</tr>
<tr>
<td>Total</td>
<td>:</td>
